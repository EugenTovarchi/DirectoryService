...
using DirectoryTimeZone = DirectoryService.Contracts.ValueObjects.TimeZone;
            ...
            modelBuilder.Entity("DirectoryService.Domain.Entities.Department", b =>
                {
                    ...
                    b.Property<string>("Path")
                        .IsRequired()
                        .HasMaxLength(DirectoryPath.MAX_LENGTH)
                        .HasColumnType("ltree")
                        .HasColumnName("path");
                    ...
                    b.OwnsOne("DirectoryService.Contracts.ValueObjects.TimeZone", "TimeZone", b1 =>
                        {
                            ...
                            b1.Property<string>("Value")
                                .IsRequired()
                                .HasMaxLength(DirectoryTimeZone.MAX_LENGTH)
