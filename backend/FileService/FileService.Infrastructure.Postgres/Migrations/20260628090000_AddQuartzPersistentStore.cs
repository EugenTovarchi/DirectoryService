...
[Migration("20260628090000_AddQuartzPersistentStore")]
    ...
    protected override void Up(MigrationBuilder migrationBuilder)
    {
        migrationBuilder.Sql(
            ...
            CREATE INDEX idx_qrtz_j_req_recovery
                ON quartz.qrtz_job_details (requests_recovery);
            CREATE INDEX idx_qrtz_t_next_fire_time
                ON quartz.qrtz_triggers (next_fire_time);
            CREATE INDEX idx_qrtz_t_state
                ON quartz.qrtz_triggers (trigger_state);
            CREATE INDEX idx_qrtz_t_nft_st
                ON quartz.qrtz_triggers (next_fire_time, trigger_state);
            CREATE INDEX idx_qrtz_ft_trig_name
                ON quartz.qrtz_fired_triggers (trigger_name);
            CREATE INDEX idx_qrtz_ft_trig_group
                ON quartz.qrtz_fired_triggers (trigger_group);
            CREATE INDEX idx_qrtz_ft_trig_nm_gp
                ON quartz.qrtz_fired_triggers (sched_name, trigger_name, trigger_group);
            CREATE INDEX idx_qrtz_ft_trig_inst_name
                ON quartz.qrtz_fired_triggers (instance_name);
            CREATE INDEX idx_qrtz_ft_job_name
                ON quartz.qrtz_fired_triggers (job_name);
            CREATE INDEX idx_qrtz_ft_job_group
                ON quartz.qrtz_fired_triggers (job_group);
            CREATE INDEX idx_qrtz_ft_job_req_recovery
                ON quartz.qrtz_fired_triggers (requests_recovery);
            """);
    }
