...
namespace AuthService.Infrastructure.Postgres.Migrations
{
    ...
    [Migration("20260720090855_AddEmailOutbox")]
...
#pragma warning disable 612, 618
            ...
            modelBuilder.Entity("AuthService.Domain.EmailDelivery.EmailOutboxMessage", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AuthService.Domain.Identity.AuthAuditEvent", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
            ...
            modelBuilder.Entity("AuthService.Domain.Identity.PasswordResetToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "UsedAt", "RevokedAt", "ExpiresAt")
            ...
            modelBuilder.Entity("AuthService.Domain.Identity.UserInviteToken", b =>
                {
                    b.Property<Guid>("Id")
                        .ValueGeneratedOnAdd()
                        .HasColumnType("uuid")
                    ...
                    b.HasIndex("UserId", "AcceptedAt", "RevokedAt", "ExpiresAt")
            ...
            modelBuilder.Entity("AuthService.Domain.Identity.UserInviteToken", b =>
                {
                    b.HasOne("AuthService.Domain.Identity.ApplicationUser", "CreatedByUser")
                        .WithMany()
