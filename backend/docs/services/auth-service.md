...
Последние проверки проходили: build `0 warnings / 0 errors`, unit `1/1`, integration `21/21`.

Следующий ближайший AuthService блок: `GET /api/auth/me`, чтобы клиент мог получить текущего пользователя, roles, permissions и company context из authenticated request.
